...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    ...
    <ul class="navbar-nav navbar-sidenav" id="exampleAccordion" style="background: linear-gradient(to right, rgba(0,128,128,0), rgba(0,128,128,1));">
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Offer Course">
                <a class="nav-link" href="#" onclick="callOfferCourse()">
                  <i class="fa fa-fw fa-pencil-square-o"></i>
                  <span class="nav-link-text">Offer Course</span>
                </a>
        </li>

      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Course Settings">
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Course Assessment">
        <a class="nav-link" href="${request.contextPath}/instructor/courseAssessment" >
          <i class="fa fa-fw fa-check"></i>
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Course Help">
              <a class="nav-link" onclick="callInstructorHelp()">
                ...
                <span class="nav-link-text">Course Help</span>
              <a>
        </li>
