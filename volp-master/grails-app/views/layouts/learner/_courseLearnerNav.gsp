...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="mainNav">
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    ...
    <!--  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="View Course">
        <a class="nav-link" href="#" >
          <i class="fa fa-fw fa-book"></i>
          <span class="nav-link-text">View Course</span>
        </a>
      </li> -->
    ...
    <!--  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Menu Yet to be decided">
              <a class="nav-link" href="#">
      ...
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Certificate">
        ...
        <a class="nav-link" href="">
          ...
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Exam">
                <a class="nav-link" href="#" onclick="generateQuestionPattern('Learner')"/>
                  <i class="fa fa-fw fa-money"></i>
