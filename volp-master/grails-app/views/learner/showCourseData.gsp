 ...
 <div class="panel panel-default">
   <div class="panel-heading">
     <h4 class="panel-title">
       <a class="form-control" data-toggle="collapse" href="#v${list.id}">Video(s)&nbsp&nbsp&nbsp <i class="fa fa-plus"></i></a>
     </h4>
   </div>
...
<div class="panel-group">
 <div class="panel panel-default">
   <div class="panel-heading">
     <h4 class="panel-title">
       <a class="form-control" data-toggle="collapse" href="#m${list.id}">Topic Material (s)&nbsp&nbsp&nbsp <i class="fa fa-plus"></i></a>
     </h4>
   </div>
...
<div class="panel-group">
  <div class="panel panel-default">
   <div class="panel-heading">
     <h4 class="panel-title">
       <a class="form-control" data-toggle="collapse" href="#a${list.id}"><b>Assesment(s):</b>&nbsp&nbsp&nbsp <i class="fa fa-plus"></i></a>
     </h4>
   </div>
