                          ...
                          <div class="col-sm-3">
                                  <div class="card" >
                                         <div class="card-header card-title" style="color:blue;font-weight: bold;">
                                           ...
                                           <g:link action="enrollLogin" style="font-size:16px; float:right" class="btn btn-success" controller="enroll" params="[coffr:coffrobj[0].id]">
                                               Enroll Now
                                           </g:link>
                                            </g:if>
                                            <g:else>
                                                <g:link style="font-size:16px; float:right" action="payFee" class="btn btn-success"controller="enroll" params="[coffr:coffrobj[0].id]">
                                                   Enroll Now
                                                </g:link>
                                            </g:else>
                                         </div>
